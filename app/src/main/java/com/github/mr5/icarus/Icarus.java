...
public class Icarus {
    ...
    public Icarus(Toolbar toolbar, WebView webView) {
    ...
    /**
     * Execute callback function under javascript runtime.
     *
    ...
    /**
     * Remove callback function under javascript runtime.
     *
    ...
    public void render() {
        initialize();
        webView.loadUrl("http://192.168.11.44:8080/");
    }
